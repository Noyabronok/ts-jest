...
export { nodeModulesTransformPattern } from './patterns/node-modules-transform-pattern'
export type { NodeModulesTransformPatternOptions } from './patterns/node-modules-transform-pattern'
